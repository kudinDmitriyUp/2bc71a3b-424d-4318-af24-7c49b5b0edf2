...
export const metadata: Metadata = {
  title: "OnlyFans Creator Hub - Monetize Your Content",
  description: "Join millions of creators earning on the world's leading content platform. 80% revenue share, advanced analytics, direct fan engagement. Start creating today.",
  keywords: "content creator, monetize content, OnlyFans, creator platform, adult content, subscription platform, creator earnings",
  metadataBase: new URL("https://onlyfans.com"),
  alternates: {
    canonical: "https://onlyfans.com"
  },
  openGraph: {
    title: "OnlyFans Creator Hub - Transform Your Passion Into Profit",
    description: "Join millions of creators earning on the world's leading content platform. 80% revenue share, advanced analytics, direct fan engagement.",
    url: "https://onlyfans.com",
    siteName: "OnlyFans Creator Hub",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32pj8e1GcgiOEWWC6aYveoEdoWX/uploaded-1763241745777-gfx67hwb.jpg",
      alt: "OnlyFans creator dashboard"
    }],
    type: "website"
  },
  twitter: {
    ...
    title: "OnlyFans Creator Hub - Monetize Your Content",
    description: "Join millions of creators earning on the world's leading content platform. Start your creator journey today.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32pj8e1GcgiOEWWC6aYveoEdoWX/uploaded-1763241745777-gfx67hwb.jpg"]
  },
  robots: {
    index: true,
    follow: true
